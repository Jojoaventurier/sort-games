 ...
 */
final class Version20260228165113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_entry (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, normalized_name VARCHAR(255) DEFAULT NULL, fuzzy_name VARCHAR(255) NOT NULL, tag VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, version VARCHAR(255) DEFAULT NULL, game_list_id INT NOT NULL, INDEX IDX_1912E4FFA86C69A4 (game_list_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
